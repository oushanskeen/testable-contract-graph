...
const argv = yargs(hideBin(process.argv))
    ...
    .help('h')
    .alias('h', 'help')
    .epilog('Example: node verify.js --contractGraph contractGraph.md --verifications verifications')
    .argv;
...
const memory: any = {}
const tcg = (mermaidGraphFileName: FileName, specFolder: SpecFolder) => {
...
tcg(contractGraphPath, verificationsPath).verifiedMemaidRequirementsFromFile_v()
